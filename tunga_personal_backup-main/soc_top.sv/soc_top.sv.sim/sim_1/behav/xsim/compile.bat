...
REM
REM Generated by Vivado on Sat May 16 15:20:16 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_tunga_soc_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_tunga_soc_vlog.prj -log xvlog.log
